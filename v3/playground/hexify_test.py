...
def test_hexify_offset():
    h = hexify.Hexify(16)
    assert h._hexify_offset(0x00000000) == "00000000"
    assert h._hexify_offset(0xffffffff) == "FFFFFFFF"
    assert h._hexify_offset(0x12345678) == "12345678"
    assert h._hexify_offset(0x9ABCDEF0) == "9ABCDEF0"
